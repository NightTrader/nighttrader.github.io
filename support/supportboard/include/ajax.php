...
function sb_ajax_execute() {
    ...
    switch ($function) {
        ...
        case 'new-conversation':
            return sb_json_response(sb_new_conversation($_POST['user_id'], sb_post('status_code'), sb_post('title', ''), sb_post('department', -1), sb_post('agent_id', -1), sb_post('source'), sb_post('extra'), sb_post('extra_2'), sb_post('tags')));
